...
### Welcome Page
![Welcome Page](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/fd1893e8-48da-402b-bca9-353f70c07dbf))
...
### Profile
![Profile](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/5588bd57-3246-44f0-876e-3593560ddc62))

Users can see and edit their profile on this page.

### Friends
![Friends page](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/19886728-bd5e-4101-8a2d-acb8215509ab))

Users can search other users by username and click add to send friend requests to them.

### Notification
![Notification page](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/1b1bc7e2-79a9-4e00-bdcb-dd5d54e149e1))

Users will see a red node in header when they receive friends or games invite. They can accept or reject these requests.

### Lobby
![Lobby](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/cbb4e1b5-9862-4baa-aad5-619e18e72492))
...
![Waiting Area](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/20c597a0-5ea3-4b45-a037-0cb59e825293))
...
![Word Selction](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/e62347f6-289b-472f-aa8a-a960846b9871))

Once each turn starts, the drawing player has 20 seconds to select one word from three given words.

![Drawing Stage of Drawing Player](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/784c9d82-f52b-4d8e-9f20-7c3fa767d0fa))

The drawing player has 60 seconds to draw a picture to describe the word.

![Drawing Stage of Guessing Player](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/54bf0e89-2ecd-47a1-a9b1-3e26a5b76934)))

The guessing player can see the live drawing board when drawing player is drawing.

![Guessing Stage](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/f8547e70-fb50-494a-a49a-7583821502eb))
The Guessing player can guess the word in 60 seconds and all players can download the picture result.

![Turn Rank](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/9427282c-92a9-48a9-b1b1-6267bdee3ed8))

After each turn, there is a short conclusion of the painting, conrrect answer and each player’s score.

![Final Rank](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/ec72d8da-f5f9-4773-94a8-bc5cfc4d461d))

After every player becomes the drawing player once, the game ends. And the final leaderboard will show to all players.

### Leaderboard

![Leaderboard](![image](https://github.com/sopra-fs23-group-19/sopra-fs23-group-19-client/assets/91188113/859dbcb2-7129-454f-b66f-390d52b1ca3a))
